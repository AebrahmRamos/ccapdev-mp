...
export default function CafeOwnerProfile() {
    ...
    const ownerData = {
        ...
        coverImage: "https://t3.ftcdn.net/jpg/01/94/82/86/360_F_194828624_llDpKzFNYmi6cfHVF8GOOoAe5KTJlc9N.jpg"
    };
                ...
                <div className="cafe-details">
                    <div className="cafe-content">
                        ...
                        <div className="cafe-logo-container">
                            <img src={cafeData.logo} alt={`${cafeData.name} logo`} className="cafe-logo" />
